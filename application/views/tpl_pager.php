...
if( isSet( $pagerConfig ) && $pagerConfig['count'] > 0 ) {
    ...
    if ($pagerConfig['page'] > 1) {
        echo '<a class="paginator" href="' . str_replace( 'key_page', 1, $pagerConfig['url'] ) . '">PIERWSZA</a>';
        echo '<a class="paginator" href="' . str_replace( 'key_page', ( $pagerConfig['page'] - 1 ), $pagerConfig['url'] ) . '"> POPRZEDNIA </a>';
    }
    ...
    if ($pagerConfig['page'] < ceil($counter / 10) + 1) {
        echo '<a class="paginator" href="' . str_replace( 'key_page', ( $pagerConfig['page'] + 1 ), $pagerConfig['url'] ) . '"> KOLEJNA </a>';
    }
    ...
    if ($pagerConfig['page'] != (ceil($counter / 10) + 1)) {
        ...
        echo '<a class="paginator" href="' . str_replace( 'key_page', (ceil($counter / 10) + 1), $pagerConfig['url'] ) . '"> OSTATNIA </a>';
    }
